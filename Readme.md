...
_Note: We may free up resources by stopping Jenkins and Keycloak since we're not using them anymore._
...
_Addendum: If you need to enable MongoDB service again later, run the command in terminal:_
